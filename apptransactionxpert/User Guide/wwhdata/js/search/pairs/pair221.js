...
x.t("legal","notices");
x.t("notice","legal");
x.t("syntax","tier_pair.get_num_connections");
x.t("number","connections");
x.t("tier_pair.get_num_connections","argument");
x.t("2013","riverbed");
x.t("software","may");
x.t("may","covered");
...
x.t("tier","pair");
x.t("get_num_connections","user");
x.t("get_num_connections","abstract");
x.t("get_num_connections","get_num_connections");
x.t("applications","scripts");
x.t("riverbed","support");
x.t("riverbed","technology");
x.t("class","syntax");
x.t("class","tier_pair");
x.t("class","get_num_connections");
x.t("returns","number");
x.t("covered","u.s");
