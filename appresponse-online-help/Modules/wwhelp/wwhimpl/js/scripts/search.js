...
function  WWHSearch_HoverTextTranslate(ParamEntryID)
{
  ...
  // Get Book
  //
  if ((BookList.length > 0) &&                 // More than one book exists
