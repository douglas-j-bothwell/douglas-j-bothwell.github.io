...
function  WWHSearch_StartHTMLSegments()
{
  ...
  if (this.mbPanelInitialized)
  {
    ...
    else
    {
      ...
      {
        HTML.fAppend("<p><strong>Type the word(s) that you want to search for.</strong></p>&#10;&#10;<p><strong>Search Tips:</strong></p><ul><li><p><strong>Criteria</strong>&#151;The search returns only pages that include all specified words. For example, <strong><i>tcp ip</i></strong> finds all topics with both &#147;IP&#148; and &#147;TCP&#148;. </p></li><li><p><strong>Special Characters</strong>&#151;The search does not accept special characters such as quotes, punctuation, and underscores. To search for a string with special characters, enter the string with spaces instead. Examples: <strong><i>op&#160;stat&#160;write</i></strong> for &#147;op_stat_write&#148;; <strong><i>mod&#160;dirs</i></strong> for &#147;mod_dirs&#148;; <strong><i>multi&#160;tier</i></strong> for &#147;multi-tier&#148;. </p></li><li><p><strong>Wildcard/Word Stemming</strong>&#151;Use an asterisk (*) to search for word stems. Examples: <strong><i>rout*</i></strong> finds &#147;routes&#148;, &#147;routing&#148;, etc.; <strong><i>window*</i></strong> finds &#147;window&#148;, &#147;windowing&#148;, etc. Other types of wildcards are not supported. </p></li><li><p><strong>Targeted Searches</strong>&#151;To search a specific part of the documentation, use the pull-down menu below the search field. </p></li><li><p><strong>Cases</strong>&#151;Searches are not case-sensitive. </p></li><li><p><strong>Excluded Words</strong>&#151;Common and single-character words such as <i>the</i>, <i>of</i>,  and <i>a</i> are ignored. </p></li></ul><p>To see these tips again after conducting a search, clear the search field and click &#147;Go!&#148;.</p>");
      }
