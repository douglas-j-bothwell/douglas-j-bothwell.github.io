...
function  WWHControls_Object()
{
  ...
  this.fClickedHome           = WWHControls_ClickedHome;
  ...
  this.fHome                  = WWHControls_Home;
  this.fPDFLink               = WWHControls_PDFLink;
...
function  WWHControls_Initialize()
{
  ...
  this.fAddControl("WWHRelatedTopicsIcon", VarSettings.mbRelatedTopicsEnabled, false,
                   ...
                   "home.gif", "homex.gif", "fClickedHome", "WWHControlsRightFrame");
  this.fAddControl("WWHPDFIcon", this.mbPDFEnabled, false,
				   "PDF",
...
function  WWHControls_RightHTML()
{
  ...
  if (this.fGetControl("WWHRelatedTopicsIcon") != null)
  {
    ...
    VarHTML += this.fGetControl("WWHPDFIcon").fGetHTML();
...
function  WWHControls_UpdateHREF(ParamHREF)
{
  ...
  this.fGetControl("WWHRelatedTopicsIcon").fSetStatus(this.fCanSyncTOC());
  this.fGetControl("WWHEmailIcon").fSetStatus(this.fCanSyncTOC());
  this.fGetControl("WWHPDFIcon").fSetStatus(this.fCanSyncTOC());
...
function  WWHControls_ClickedHome()
{
   this.fHome()
...
{
  var  VarJoinedLocation;
  var  VarDocURL;
  var  VarFile;
  
  VarJoinedLocation = WWHFrame.WWHHelp.fGetFrameReference("WWHDocumentFrame") + ".PDFLocation()";
  VarFile                      = eval(VarJoinedLocation);
  VarDocURL              = WWHFrame.WWHHelp.mBaseURL + VarFile;
  
   {
      window.open(VarDocURL);
   }
}
...
function  WWHControls_Home()
{
  var  VarDocURL;


  VarDocURL = WWHFrame.WWHHelp.mHelpURLPrefix + "wwhelp/wwhimpl/common/html/default.htm";
  
  if (this.fCanSyncTOC())
  {
    WWHFrame.WWHHelp.fSetLocation("WWHDocumentFrame", VarDocURL);
  }
}
...
function  WWHControls_ProcessAccessKey(ParamAccessKey)
{
  switch (ParamAccessKey)
  {
    ...
    case 10:
      this.fClickedPDFLink();
      break;
  }
}

function  WWHControls_PDFLink()
{
  var  VarJoinedLocation;
  var  VarDocURL;
  var  VarFile;
